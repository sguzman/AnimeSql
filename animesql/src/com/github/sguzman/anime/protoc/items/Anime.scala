...
final case class Anime(
    summary: scala.Option[com.github.sguzman.anime.protoc.items.AnimeSummary] = None,
    ...
    def mergeFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.github.sguzman.anime.protoc.items.Anime = {
      ...
      while (!_done__) {
        ...
        _tag__ match {
          case 0 => _done__ = true
          case 10 =>
            __summary = Option(_root_.scalapb.LiteParser.readMessage(_input__, __summary.getOrElse(com.github.sguzman.anime.protoc.items.AnimeSummary.defaultInstance)))
          case 18 =>
    ...
    def getSummary: com.github.sguzman.anime.protoc.items.AnimeSummary = summary.getOrElse(com.github.sguzman.anime.protoc.items.AnimeSummary.defaultInstance)
    def clearSummary: Anime = copy(summary = None)
    def withSummary(__v: com.github.sguzman.anime.protoc.items.AnimeSummary): Anime = copy(summary = Option(__v))
    ...
    def companion = com.github.sguzman.anime.protoc.items.Anime
}

object Anime extends scalapb.GeneratedMessageCompanion[com.github.sguzman.anime.protoc.items.Anime] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[com.github.sguzman.anime.protoc.items.Anime] = this
  def fromFieldsMap(__fieldsMap: scala.collection.immutable.Map[_root_.com.google.protobuf.Descriptors.FieldDescriptor, scala.Any]): com.github.sguzman.anime.protoc.items.Anime = {
    require(__fieldsMap.keys.forall(_.getContainingType() == javaDescriptor), "FieldDescriptor does not match message type.")
    val __fields = javaDescriptor.getFields
    com.github.sguzman.anime.protoc.items.Anime(
      __fieldsMap.get(__fields.get(0)).asInstanceOf[scala.Option[com.github.sguzman.anime.protoc.items.AnimeSummary]],
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.github.sguzman.anime.protoc.items.Anime] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      require(__fieldsMap.keys.forall(_.containingMessage == scalaDescriptor), "FieldDescriptor does not match message type.")
      com.github.sguzman.anime.protoc.items.Anime(
        __fieldsMap.get(scalaDescriptor.findFieldByNumber(1).get).flatMap(_.as[scala.Option[com.github.sguzman.anime.protoc.items.AnimeSummary]]),
  ...
  lazy val defaultInstance = com.github.sguzman.anime.protoc.items.Anime(
  )
  implicit class AnimeLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, com.github.sguzman.anime.protoc.items.Anime]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, com.github.sguzman.anime.protoc.items.Anime](_l) {
    def summary: _root_.scalapb.lenses.Lens[UpperPB, com.github.sguzman.anime.protoc.items.AnimeSummary] = field(_.getSummary)((c_, f_) => c_.copy(summary = Option(f_)))
    def optionalSummary: _root_.scalapb.lenses.Lens[UpperPB, scala.Option[com.github.sguzman.anime.protoc.items.AnimeSummary]] = field(_.summary)((c_, f_) => c_.copy(summary = f_))
