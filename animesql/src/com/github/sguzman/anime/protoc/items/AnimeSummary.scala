...
final case class AnimeSummary(
    ...
    def mergeFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.github.sguzman.anime.protoc.items.AnimeSummary = {
    ...
    def companion = com.github.sguzman.anime.protoc.items.AnimeSummary
}

object AnimeSummary extends scalapb.GeneratedMessageCompanion[com.github.sguzman.anime.protoc.items.AnimeSummary] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[com.github.sguzman.anime.protoc.items.AnimeSummary] = this
  def fromFieldsMap(__fieldsMap: scala.collection.immutable.Map[_root_.com.google.protobuf.Descriptors.FieldDescriptor, scala.Any]): com.github.sguzman.anime.protoc.items.AnimeSummary = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.github.sguzman.anime.protoc.items.AnimeSummary] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = ItemsProto.javaDescriptor.getMessageTypes.get(0)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = ItemsProto.scalaDescriptor.messages(0)
  def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[_] = throw new MatchError(__number)
  lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[_]] = Seq.empty
  def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[_] = throw new MatchError(__fieldNumber)
  lazy val defaultInstance = com.github.sguzman.anime.protoc.items.AnimeSummary(
  )
  implicit class AnimeSummaryLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, com.github.sguzman.anime.protoc.items.AnimeSummary]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, com.github.sguzman.anime.protoc.items.AnimeSummary](_l) {
