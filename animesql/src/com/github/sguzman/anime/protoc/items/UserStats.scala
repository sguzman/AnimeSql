...
final case class UserStats(
    ...
    def mergeFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.github.sguzman.anime.protoc.items.UserStats = {
    ...
    def companion = com.github.sguzman.anime.protoc.items.UserStats
}

object UserStats extends scalapb.GeneratedMessageCompanion[com.github.sguzman.anime.protoc.items.UserStats] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[com.github.sguzman.anime.protoc.items.UserStats] = this
  def fromFieldsMap(__fieldsMap: scala.collection.immutable.Map[_root_.com.google.protobuf.Descriptors.FieldDescriptor, scala.Any]): com.github.sguzman.anime.protoc.items.UserStats = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.github.sguzman.anime.protoc.items.UserStats] = _root_.scalapb.descriptors.Reads{
  ...
  lazy val defaultInstance = com.github.sguzman.anime.protoc.items.UserStats(
  )
  implicit class UserStatsLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, com.github.sguzman.anime.protoc.items.UserStats]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, com.github.sguzman.anime.protoc.items.UserStats](_l) {
